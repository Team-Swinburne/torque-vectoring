...
static const char *CompileLibs[] = {
    /* /net/dagobert/local/work.fh/cm100d/src_lib/Portings/win64/lib/libcar.a */
    /* /net/dagobert/local/work.fh/cm100d/src_lib/Portings/win64/lib/libcarmaker.a */
    ...
    "libcar.a	CarMaker-Car win64 10.1 2021-07-20",
    "libcarmaker.a	CarMaker win64 10.1 2021-07-20",
    "libipgdriver.a	IPGDriver win64 10.0 2021-03-29",
    "libipgroad.a	IPGRoad win64 10.1 2021-07-19",
...
static const char *CompileFlags[] = {
    "-m64 -O3 -DNDEBUG -DWIN32 -DWIN64 -DCM_NUMVER=100100",
...
tAppStartInfo   AppStartInfo = {
    "CarMaker 10.1 - Car_Generic",          /* App_Version         */
    "299",          /* App_BuildVersion    */
    "fh",     /* App_CompileUser     */
    "obelix.ipg",         /* App_CompileSystem   */
    "2021-07-20 16:42:55",  /* App_CompileTime */
